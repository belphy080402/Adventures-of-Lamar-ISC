...
PASSWORD:
	...
	BARRA_SELECAO:
	Impressaopequena(Barra_sele�ao, 0xFF00A53C, 0xFF10A53C, 0, 0x123, TECLADO_PASSWORD)#imprime a barra na seleÃ§ao da primeira letra
...
SEGUNDA_LETRA:
	...
	IMPRIME_SEGUNDA:
		Impressaopequena(Barra_sele�ao, 0xFF00A572, 0xFF10A572 0, 0x123, RECEBE_TECLA_PASSWORD)#imprime a barra na seleçao da segunda letra
...
TERCEIRA_LETRA:			#carrega display do KDMMIO, segunda letra
	...
	IMPRIME_TERCEIRA:
		Impressaopequena(Barra_sele�ao, 0xFF00A5A7, 0xFF10A5A7 0, 0x123, RECEBE_TECLA_PASSWORD)#imprime a barra na seleçao da terceira letra
...
QUARTA_LETRA:
	...
	IMPRIME_QUARTA:
		Impressaopequena(Barra_sele�ao, 0xFF00A5DC, 0xFF10A5DC, 0, 0x123, RECEBE_TECLA_PASSWORD)#imprime a barra na seleçao da quarta letra														
#=================================TECLADO================================
MENU_TROCAFRAME:
...
.include "./Imagens/Barra_sele�ao.data"
